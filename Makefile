...
CCFLAGS =  -fpermissive -Os -m2 -falign-functions=4 -Wformat-diag -Wno-conversion-null -fno-lto -Wshadow -Wall -Wswitch -Wpadded -fno-common -Wextra -Wno-narrowing -fno-web -fno-builtin -funit-at-a-time -Wwrite-strings -Wl,--strip-all -Wl,--verbose -mno-fsrra -maccumulate-outgoing-args -fomit-frame-pointer -DUSE_HIRES -D_SH -DMODEL_S -DUSE_SPRITES -DPONY -DUSE_ADX -DUSE_SLAVE -DEMBEDDED
